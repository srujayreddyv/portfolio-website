...
export default function ContactForm({ onSubmit }: ContactFormProps) {
  ...
  const inputError = ' border-[var(--destructive)]';
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        />
        {errors.name && (
          <p className="mt-1 font-mono text-xs text-[var(--destructive)]">
            {errors.name.message}
          </p>
        )}
      </div>
      ...
      {submitStatus === 'error' && (
        <div className="p-3 border border-[var(--destructive)] bg-[var(--destructive)]/10 font-mono text-sm text-ink">

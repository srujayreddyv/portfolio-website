 ...
 * header. Logos squared with a hairline border. Achievement bullets use an
 * accent "›" glyph. Tech tags are mono hairline-bordered chips.
 *
 ...
 * The current role (dds-2025) is expanded by default.
 */
          ...
          <div className="space-y-5 sm:space-y-6">
            {experiences.map((exp) => {
              ...
              return (
                ...
                >
                  {/* Summary row — always visible, toggles the panel */}
                  <button
                    type="button"
